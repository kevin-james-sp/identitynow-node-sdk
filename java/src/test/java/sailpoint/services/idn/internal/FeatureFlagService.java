...
public class FeatureFlagService{
	...
	*//**
	 ...
	 */
	private void patchFeatureFlag(Enum<?> key, java.util.List<com.google.gson.JsonElement> patchJson, boolean expectedValue) {
